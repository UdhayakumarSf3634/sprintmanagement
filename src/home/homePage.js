...
function renderButton() {
    var _a;
    (_a = document.getElementById('imageWithButton')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () {
    ...
    gantt = new ej2_gantt_1.Gantt({
        ...
        actionComplete: function (args) {
            if (args.requestType == 'openEditDialog' ||
                ...
                var tabObj_1 = document.getElementById('Gantt_Tab')['ej2_instances'][0];
                tabObj_1.selected = function (args) {
                    if (args.selectedIndex == 2) {
                        var gridObj_1 = document.getElementById('GanttResourcesTabContainer_gridcontrol')['ej2_instances'][0];
...
function updateCardElement(selector, count) {
